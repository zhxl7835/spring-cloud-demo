package com.zhengxiaolong.springcloudeurekaconsumer80;

import com.zhengxiaolong.springcloudeurekaconsumer80.config.MySelfRibbonRuleConfig;
...
@RibbonClient(name = "spring-cloud-eureka-provider", configuration = MySelfRibbonRuleConfig.class)
public class SpringCloudEurekaConsumer80Application {
