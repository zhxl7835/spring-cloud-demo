package com.zhengxiaolong.springcloudeurekaconsumer80.controller;
...
public class DeptController_Consumer {
    ...
    private static final String REST_URL_PROVIDER_PREFIX = "http://spring-cloud-eureka-provider"; // 使用注册到 Spring Cloud Eureka 服务注册中心中的服务，即 application.name
    @Autowired
